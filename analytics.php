...
<head>
    ...
    <style>
        ...
        * {
        ...
        .btn-info {
            background: linear-gradient(135deg, var(--info) 0%, #2968c9 100%);
            color: white;
            border: none;
        }

        .btn-info:hover {
            background: linear-gradient(135deg, var(--info) 0%, #1a56b4 100%);
            color: white;
            border: none;
        }

        .btn-warning {
            background: linear-gradient(135deg, var(--warning) 0%, #ff9d00 100%);
            color: white;
            border: none;
        }
